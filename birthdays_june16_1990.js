/**
 * Calculate all lunar birthdays from 1990 to 2025 for June 16, 1990
 */
...
const birthDate = new Date(1990, 5, 16); // month is 0-indexed
const birthTithi = calculateTithi(1990, 6, 16);
const birthDayOfYear = getDayOfYear(birthDate);

console.log('================================================================================');
console.log('ALL LUNAR BIRTHDAYS FROM 1990 TO 2025');
console.log('================================================================================');
console.log(`Birth date: June 16, 1990 (Day ${birthDayOfYear} of year)`);
console.log(`Birth tithi: ${birthTithi}`);
console.log('================================================================================\n');

const allBirthdays = [];

// Calculate for each year from 1990 to 2025
